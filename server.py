...
host="192.168.1.5"  # içerideki ip adresi localhost olarak geçer.
port=12345

try:  # try ile kod bloğunu hatalara karşı denetlemeye aldım.

    server_socket=socket.socket(socket.AF_INET,socket.SOCK_STREAM)  #AF_INET ile IPV4 adresleme SOCK_STREAM ile de TCP bağlantı tipini belirtiriz.
